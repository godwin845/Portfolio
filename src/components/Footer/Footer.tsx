    ...
    <div className='mx-4 sm:mx-8 md:mx-16 lg:mx-44 my-12 flex flex-col gap-8 mt-12 sm:mt-24 md:mt-32'>
        <div className="flex flex-col sm:flex-row justify-between">
            <div className="max-w-[400px] mb-8 sm:mb-0">
                <h1 className='text-5xl font-bold mb-2'><span className='text-5xl font-bold bg-gradient-to-r from-[#DF8908] to-[#B415FF] rounded-3xl'>John </span>Wick</h1>
        ...
        <div className="flex flex-col sm:flex-row justify-between text-lg mt-8 mb-12">
            <p className="text-xl">Copyright &copy; 2025 John Wick. All rights reserved.</p>
